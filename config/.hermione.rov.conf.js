module.exports = {
    ...
    browsers: {
        chrome_fhd: {
            ...
            screenshotsDir: 'screen/rov/chrome/1920',
            desiredCapabilities: {
                browserName: 'chrome',
                chromeOptions: {
                    args: ['--headless']
         ...
         chrome_1440: {
             compositeImage: true,
             windowSize: '1440x900',
             screenshotsDir: 'screen/rov/chrome/1440',
             desiredCapabilities: {
                 browserName: 'chrome',
                 chromeOptions: {
                     args: ['--headless']
         ...
         mobile: {
             screenshotsDir: 'screen/rov/chrome/mobile',
             compositeImage: true, 
             desiredCapabilities: {
                 browserName: 'chrome',
                 version: '71.0',
        ...
        ie11_fhd: {
            compositeImage: true,
            windowSize: '1920x1080',
            screenshotsDir: 'screen/rov/ie/1920',
            desiredCapabilities: {
        ...
        ie11_fhd: {
            compositeImage: true,
            windowSize: '1440x900',
            screenshotsDir: 'screen/rov/ie/1440',
            desiredCapabilities: {
                browserName: 'internet explorer',
                version: '11',
                'ie.enableFullPageScreenshot': false
